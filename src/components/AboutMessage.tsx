...
type Instruction = { label?: string; text: React.ReactNode };
const homeScreenInstructions: Record<string, Instruction[]> = {
...
export const aboutMessageProps = {
  ariaLabel: "Show app information",
  toggleText: "What is this?",
  content: (
    <>
